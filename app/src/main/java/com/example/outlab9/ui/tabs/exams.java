...
public class exams extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.exam_recyclerView);
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.exam_swipeRefresh);


        dbHelper = new DBHelper(getContext());
        arrayList = dbHelper.getData(2);
        DataAdapter d = new DataAdapter(arrayList, 2);
